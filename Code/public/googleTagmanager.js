...
(function () {
    ...
    */
    ...
    var Ba = function () {
        ...
        Ha = function (a) {
            ...
            Array.isArray
                ? Array.isArray(a) !== b && za("TAGGING", 4)
                : za("TAGGING", 5);
            return b;
        },
        Ia = function (a, b) {
 ...
 jQuery v1.9.1 (c) 2005, 2012 jQuery Foundation, Inc. jquery.org/license. */
        ...
        ac = function (a, b, c) {
            if (Ha(a)) {
                ...
                switch (a[0]) {
                    ...
                    case "escape":
                        d = ac(a[1], b, c);
                        if (Yb && Ha(a[1]) && "macro" === a[1][0] && Yb.Ih(a))
                            return Yb.Yh(d);
                        d = String(d);
    ...
    var jc = {
        jh: function (a, b) {
            b[qb.ce] &&
            "string" === typeof a &&
            (a = 1 == b[qb.ce] ? a.toLowerCase() : a.toUpperCase());
 ...
 Copyright (c) 2014 Derek Brans, MIT license https://github.com/krux/postscribe/blob/master/LICENSE. Portions derived from simplehtmlparser, which is licensed under the Apache License, Version 2.0 */
    ...
    (C.Sc = "page_view"),
        (C.ne = "user_engagement"),
        (C.Sf = "app_remove"),
        (C.Tf = "app_store_refund"),
        (C.Uf = "app_store_subscription_cancel"),
        (C.Vf = "app_store_subscription_convert"),
        (C.Wf = "app_store_subscription_renew"),
        (C.Zf = "first_open"),
        (C.$f = "first_visit"),
        (C.ag = "in_app_purchase"),
        (C.bg = "session_start"),
        (C.cg = "allow_custom_scripts"),
        (C.dg = "allow_display_features"),
        (C.Tc = "allow_enhanced_conversions"),
        (C.De = "enhanced_conversions"),
        (C.Za = "client_id"),
        (C.W = "cookie_domain"),
        (C.Zb = "cookie_name"),
        (C.La = "cookie_path"),
        ...
        (C.$a = "language"),
        (C.ve = "country"),
        (C.xi = "non_interaction"),
        (C.vb = "page_location"),
        (C.Ca = "page_referrer"),
        (C.cd = "page_title"),
        (C.wb = "send_page_view"),
        (C.Ma = "send_to"),
        (C.ed = "session_engaged"),
        (C.fc = "session_id"),
        (C.fd = "session_number"),
        (C.yg = "tracking_id"),
        (C.ka = "linker"),
        (C.Ea = "url_passthrough"),
        (C.ab = "accept_incoming"),
        (C.I = "domains"),
        (C.eb = "url_position"),
        (C.cb = "decorate_forms"),
        (C.Ie = "phone_conversion_number"),
        (C.Ge = "phone_conversion_callback"),
        (C.He = "phone_conversion_css_class"),
        (C.Je = "phone_conversion_options"),
        (C.sg = "phone_conversion_ids"),
        (C.rg = "phone_conversion_country_code"),
        (C.oe = "aw_remarketing"),
        (C.pe = "aw_remarketing_only"),
        (C.Yb = "gclid"),
        (C.Fa = "value"),
        (C.ug = "quantity"),
        (C.ig = "affiliation"),
        ...
        (C.Vc = "list_name"),
        (C.Ae = "checkout_step"),
        (C.ze = "checkout_option"),
        (C.jg = "coupon"),
        (C.kg = "promotions"),
        (C.yb = "transaction_id"),
        (C.zb = "user_id"),
        (C.vg = "retoken"),
        (C.sb = "conversion_linker"),
        (C.rb = "conversion_cookie_prefix"),
        (C.aa = "cookie_prefix"),
        (C.V = "items"),
        (C.ue = "aw_merchant_id"),
        (C.se = "aw_feed_country"),
        (C.te = "aw_feed_language"),
        (C.qe = "discount"),
        (C.ye = "disable_merchant_reported_purchases"),
        (C.Fe = "new_customer"),
        (C.we = "customer_lifetime_value"),
        (C.hg = "dc_natural_search"),
        (C.gg = "dc_custom_params"),
        (C.zg = "trip_type"),
        (C.qg = "passengers"),
        (C.og = "method"),
        (C.xg = "search_term"),
        ...
        (C.hc = "update"),
        (C.Yc = "firebase_id"),
        (C.bc = "ga_restrict_domain"),
        (C.Xc = "event_settings"),
        (C.Uc = "dynamic_event_settings"),
        (C.wg = "screen_name"),
        (C.ng = "_x_19"),
        (C.mg = "_x_20"),
        (C.bd = "internal_traffic_results"),
        (C.Ke = "traffic_type"),
        (C.cc = "referral_exclusion_definition"),
        (C.ad = "ignore_referrer"),
        (C.gd = "delivery_postal_code"),
        (C.Ee = "estimated_delivery_date"),
        (C.fg = "developer_id"),
        (C.Ag = [
            C.ia,
            C.Tc,
    ...
    (C.Me = [C.vb, C.Ca, C.cd, C.$a, C.wg, C.zb, C.Yc]),
    (C.Cg = [C.Sf, C.Tf, C.Uf, C.Vf, C.Wf, C.Zf, C.$f, C.ag, C.bg, C.ne]),
    (C.$d = [
        C.ia,
        C.Tc,
        C.oe,
    ...
    var Wc = function (a) {
            return a instanceof Vc && a.constructor === Vc
                ? a.m
                : "type_error:SafeHtml";
        },
        Uc = {},
        Xc = new Vc((qa.trustedTypes && qa.trustedTypes.emptyHTML) || "", 0, Uc);
    var Yc = (function (a) {
            var b = !1,
                c;
            return function () {
    ...
    var G = window,
        H = document,
        ad = navigator,
        bd = H.currentScript && H.currentScript.src,
        cd = function (a, b) {
            var c = G[a];
            G[a] = void 0 === c ? b : c;
            return G[a];
        ...
        gd = function (a, b, c) {
            ...
            e = new Oc(h, Nc);
            d.src =
                e instanceof Oc && e.constructor === Oc
                    ? e.m
        ...
        if (void 0 != b) {
            ...
            if ("" === d || q === e || (q === d ? p !== e : !q && !p)) {
                ...
                G.setTimeout(function () {
                    k[a] === u &&
                    u.quiet &&
                    ((u.quiet = !1), Ad(a), zd(), za("TAGGING", 2));
                }, f);
            }
        }
    }
    ...
    var Kd = [C.B, C.J],
        Ld = function (a) {
            ...
            var c = a[C.be];
            c && F(41);
            for (var d = Ha(b) ? b : [b], e = 0; e < d.length; ++e)
                for (var f in a)
                    if (a.hasOwnProperty(f) && f !== C.ae && f !== C.be)
                        if (-1 < Ia(Kd, f)) {
                            var h = f,
                                k = a[f],
                                l = d[e];
                            vd().set(h, k, l, "CA", "CA-QC", c);
                        } else {
                        }
        },
        Md = function (a, b) {
    ...
    var ge = /:[0-9]+$/,
        ...
        ke = function (a, b, c, d, e) {
            ...
            if ("protocol" === b || "port" === b)
                a.protocol = ie(a.protocol) || ie(G.location.protocol);
            "port" === b
                ? (a.port = String(
            ...
            for (
                ...
                if (!(0 <= qe.indexOf(k.tagName.toUpperCase()))) {
                    for (var l = !1, p = 0; p < k.childElementCount && 1e4 > p; p++)
                        if (!(0 <= re.indexOf(k.children[p].tagName.toUpperCase()))) {
                            l = !0;
                            break;
                        }
                    l || d.push(k);
    ...
    Je.yi = "";
    Je.Rf =
        "ChAIgOH3gQYQicbKy5HQ5d5TEicA+GCr5TqB5iQn5Kwy955YixVSjYlpIfbCyeo6xqJousfsYAF/WqAaAhZR";
    var Le = {
            __cl: !0,
            __ecl: !0,
            __ehl: !0,
    ...
    var Pe = Oe,
        ...
        Re = null,
        Se = null,
        Te = "//www.googletagmanager.com/a?id=" + Je.D + "&cv=1",
        Ue = {},
        Ve = {},
        We = function () {
            var a = L.sequence || 1;
    ...
    function tf(a, b, c) {
        for (var d = [], e = sf(a, void 0, void 0, c), f = 0; f < e.length; f++) {
            ...
            if (!b || -1 !== b.indexOf(k)) {
                ...
                l &&
                ((l = l.split("-")),
                    d.push({id: h.join("."), xc: 1 * l[0] || 1, Ob: 1 * l[1] || 1}));
            }
        }
        return d;
    }
    ...
    var Ef = function () {
            for (
                var a = ad.userAgent + (H.cookie || "") + (H.referrer || ""),
                    b = a.length,
                    c = G.history.length;
                0 < c;
            )
                a += c-- ^ b++;
            return [
                Math.round(2147483647 * Math.random()) ^ (nf(a) & 2147483647),
                Math.round(Za() / 1e3)
            ].join(".");
        },
                    ...
                    if (
                        ...
                        for (var l = [], p = 0; p < k.length; p += 3) {
                            var q = p + 1 < k.length,
                                n = p + 2 < k.length,
                                u = k.charCodeAt(p),
                                t = q ? k.charCodeAt(p + 1) : 0,
                                r = n ? k.charCodeAt(p + 2) : 0,
                                v = u >> 2,
                                w = ((u & 3) << 4) | (t >> 4),
                                y = ((t & 15) << 2) | (r >> 6),
                                x = r & 63;
    ...
    var ug = /^\w+$/,
        vg = /^[\w-]+$/,
        wg = /^~?[\w-]+$/,
        xg = {aw: "_aw", dc: "_dc", gf: "_gf", ha: "_ha", gp: "_gp"},
        yg = function () {
            if (!td() || !Ed()) return !0;
            var a = Bd("ad_storage");
            return null == a ? !0 : !!a;
        ...
        Ag = function (a) {
            ...
            for (var d = {}, e = 0; e < c.length; d = {lb: d.lb}, e++) {
                d.lb = Cg(c[e]);
                var f = Dg(c[e]);
                if (d.lb && f) {
                    var h = Ja(
            ...
            if (yg()) {
                ...
                if (b && b.length)
                    for (var k = 0; k < b.length; k++) {
                        ...
                        l[1] &&
                        (h[b[k].Vd] || (h[b[k].Vd] = []),
                            h[b[k].Vd].push({timestamp: l[1], Ia: l[2]}));
                    }
                a = h;
            } else a = {};
            return a;
    ...
    var ih = function (a, b, c) {
            ...
            G[a.functionName] = d;
            if (a.qc)
                for (var e = 0; e < a.qc.length; e++) G[a.qc[e]] = G[a.qc[e]] || hh();
            ...
            if (b && c) {
                ...
                for (
                    ...
                    (h && "AW" === h.prefix && !e.adData && 2 <= h.F.length
                        ? ((e.adData = {ak: h.F[0], cl: h.F[1]}), (nh[h.id] = !0))
                        : h &&
                        "UA" === h.prefix &&
                        !e.gaData &&
                        ((e.gaData = {gaWpid: h.containerId}), (nh[h.id] = !0)));
                }
        ...
        rh = function (a, b) {
            if (a)
                if (eh()) {
                    ...
                    if (!d || e) {
                        var l = b.getWithConfig(C.Ie),
                            p;
                        if (l) {
                            Ha(l) ? (p = l) : (p = [l]);
                            var q = b.getWithConfig(C.Ge),
                                n = b.getWithConfig(C.He),
                                u = b.getWithConfig(C.Je),
                                t = b.getWithConfig(C.rg),
                                r = q || n,
                                v = 1;
                            "UA" !== a.prefix || d || (v = 5);
                            for (var w = 0; w < p.length; w++)
                                if (w < v)
                                    if (d) ph(d, p[w], t, {qa: r, options: u});
                                    else if ("AW" === a.prefix && a.F[1])
                                        qh()
                                            ? ph([a], p[w], t || "US", {qa: r, options: u})
                                            : oh(a.F[0], a.F[1], p[w], {qa: r, options: u});
                                    else if ("UA" === a.prefix)
                                        if (qh()) ph([a], p[w], t || "US", {qa: r});
                                        else {
                                            var y = a.containerId,
                                                x = p[w],
                                                A = {qa: r};
    ...
    var Ch = function (a) {
            ...
            return function (h) {
                ...
                var v = !p || u;
                v ||
                !(0 <= Ia(l, "sandboxedScripts")) ||
                (c && -1 !== Ia(c, "sandboxedScripts")) ||
                (v = Na(e, Ah));
                return (f[k] = v);
            };
        },
    ...
    var Zh = function () {
        ...
        if (!L._li && G.performance && G.performance.timing) {
            var b = G.performance.timing.navigationStart,
                c = Ga(cf.get("gtm.start")) ? cf.get("gtm.start") : 0;
    ...
    var pi = function () {
        ...
        ri = function () {
            ...
            (zi[vi] || Ai.Jh() || 0 >= Bi--
                ? (F(1), (zi[vi] = !0))
                : (Ai.di(), jd(qi()), (wi[vi] = !0), (Ci = Di = Ei = yi = xi = "")));
        },
        qi = function () {
            var a = vi;
            if (void 0 === a) return "";
    ...
    function Ni(a, b, c, d) {
        ...
        if (h && h.length) {
            ...
            f = Ni(
                ...
                {
                    onSuccess: f,
                    onFailure: 1 === k.qf ? b.terminate : f,
    ...
    function Oi(a, b, c, d) {
        function e() {
            if (f[qb.Gg]) k();
                ...
                var w = bc(f, c, []);
                var A = Uh(c.Oa, String(f[qb.Na]), Number(f[qb.bf]), w[qb.Hg]),
                    z = !1;
        ...
        if (p && p.length) {
            var q = p[0],
                n = Ni(q.index, {onSuccess: h, onFailure: k, terminate: l}, c, d);
            if (!n) return null;
            h = n;
            k = 2 === q.qf ? l : n;
        }
        if (f[qb.Xe] || f[qb.Jg]) {
            var u = f[qb.Xe] ? Vb : c.li,
                t = h,
                r = k;
            if (!u[a]) {
                e = cb(e);
    ...
    function Zi(a) {
        for (var b = [], c = 0; c < a.length; c++)
            a[c] && Le[String(Ub[c][qb.Na])] && (b[c] = !0);
        return b;
    }
    ...
    function $i(a, b) {
        ...
        for (var c = 0; c < a.length; c++)
            if (a[c] && Ub[c] && !Me[String(Ub[c][qb.Na])]) return !0;
        return !1;
    }
    ...
    Tc("Edge");
    !Tc("Gecko") ||
    (-1 != Qc.toLowerCase().indexOf("webkit") && !Tc("Edge")) ||
    Tc("Trident") ||
    Tc("MSIE") ||
    Tc("Edge");
    ...
    var dk = function (a) {
        ...
        lk = function (a, b, c, d) {
            ...
            if (q) {
                ...
                r(C.Ea) && Qg();
                N[C.I] && Ng(gk, N[C.I], N[C.eb], !!N[C.cb], y);
                rh(p, d);
                bk({
                    sd: !1,
                    ra: v,
            ...
            if (b === C.ya) {
                ...
                if (!q || (!t && !ja))
                    if ((!0 === r(C.pe) && (t = !1), !1 !== r(C.ia) || t)) {
                        ...
                        Q.google_restricted_data_processing = r(C.dd);
                        eh() &&
                        ((Q.opt_image_generator = function () {
                            return new Image();
                        }),
                        ...
                        if (t && b == C.la) {
                            Q.google_conversion_merchant_id = r(C.ue);
                        ...
                        var Y = function (la, ya) {
                                ...
                                ((Q.google_additional_conversion_params =
                                    Q.google_additional_conversion_params || {}),
                                    (Q.google_additional_conversion_params[la] = ya));
                            },
                            Ca = function (la, ya) {
                                void 0 != ya &&
                                "" !== ya &&
                                ((Q.google_additional_params =
                                    Q.google_additional_params || {}),
                                    (Q.google_additional_params[la] = ya));
                            };
                        "1" === lg(!1)._up && Y("gtm_up", "1");
    ...
    var mk = function (a) {
        ...
        pk = function (a, b, c) {
            ...
            var f = a.ud,
                ...
                l = a.yd;
            k += h
                ? "//" + f + ".fls.doubleclick.net/activityi"
                : "//ad.doubleclick.net/activity";
            var p = ";",
                q = !Nd(C.B) && !l && a.ra;
            q &&
            ((k = "https://ade.googlesyndication.com/ddm/activity"),
                (p = "/"),
                (h = !1));
            var n = [p, "src=" + ok(f), ";type=" + ok(a.xd), ";cat=" + ok(a.Fb)],
                u = a.oh || {};
            Oa(u, function (z, B) {
                n.push(";" + ok(z) + "=" + ok(B + ""));
            });
        ...
        xk = function (a, b, c, d) {
            ...
            if (e) {
                ...
                if (b === C.ya) {
                    ...
                    var x = {prefix: k, domain: l, Nb: p, flags: q},
                        A = f(C.ka) || {},
                        z = f(C.tb),
                        B = void 0 === z ? !0 : !!z;
                    h &&
                    (tg(A[C.ab], !!A[C.I]) && Mg(vk, x),
                        Kg(x),
                        Og(vk, x),
                        wk ? Yg(B, x) : Zg(B, x));
    ...
    var zk = function (a) {
            function b() {
                ...
                if (a.conversionLinkerEnabled) {
                    ...
                    if (h && h.length)
                        for (var k = 0; k < h.length; k++) f += "&gclgf=" + yk(h[k]);
                }
    ...
    var Ak = /.*\.google\.com(:\d+)?\/(?:booking|travel)\/flights.*/,
        Ck = function (a, b, c, d) {
            var e = function (E) {
            ...
            if (b === C.ya) {
                ...
                if (b === C.xa) {
                    ...
                    D &&
                    "object" === typeof D &&
                    ((B.passengers_total = Sa(D.total)),
                        (B.passengers_adult = Sa(D.adult)),
                        (B.passengers_child = Sa(D.child)),
                        (B.passengers_infant_in_seat = Sa(D.infant_in_seat)),
                        (B.passengers_infant_in_lap = Sa(D.infant_in_lap)));
                    x.conversion_data = B;
                    zk(x);
                }
            }
    ...
    var Hk = function (a, b, c, d) {
            function e() {
                Wj() && (z += "&gdpr_consent=" + encodeURIComponent(Wj())),
                Xj() && (z += "&gdpr=" + encodeURIComponent(Xj()));
                if (k) {
    ...
    var Qk = function (a, b) {
            ...
            if (Da(e)) {
                var f = "gtag_" + a.split("-").join("_"),
                    ...
                    k = function () {
                        ...
                        if (A) {
                            var z = A.action;
                            if ("impressions" === z) x("ec:addImpression", A.Dh);
                    ...
                    l = function () {
                        if (eh()) {
                            ...
                            x &&
                            (h("require", x, {dataLayer: "dataLayer"}),
                                h("require", "render"));
                        }
                    },
                    p = Rk(a, f, b, c),
                ...
                (function (x) {
                    if (x) {
                        var A = {};
                        if (ob(x))
                            for (var z in Xk) Xk.hasOwnProperty(z) && Yk(Xk[z], z, x[z], A);
                        h("require", "linkid", A);
                    }
                })(p.linkAttribution);
                var u = p[C.ka];
                if (u && u[C.I]) {
                    ...
                    gi(
                        f + ".",
                        u[C.I],
                        void 0 === t ? !!u.use_anchor : "fragment" === t,
                        !!u[C.cb]
                    );
                }
                b === C.Sc
                    ? (l(), h("send", "pageview", p.Ha))
                    : b === C.Z
                    ? (l(),
                        rh(a, c),
                    c.getWithConfig(C.Ea) && (Qg(), hi(f + ".")),
                    0 != p.sendPageView && h("send", "pageview", p.Ha),
                        Tk(a, f, c))
                    : b === C.ya
                        ? Qk(f, c)
                        : "screen_view" === b
                            ? h("send", "screenview", p.Ha)
                            : "timing_complete" === b
                                ? (q("timingCategory", p.eventCategory, !0),
                                    q("timingVar", p.name, !0),
                                    q("timingValue", Sa(p.value)),
                                void 0 !== p.eventLabel && q("timingLabel", p.eventLabel, !0),
                                    h("send", "timing", p.Ha))
                                : "exception" === b
                                    ? h("send", "exception", p.Ha)
                                    : "optimize.callback" !== b &&
                                    (0 <=
                                    Ia(
                                        [
                                        ...
                                        q("eventCategory", p.eventCategory, !0),
                                        q("eventAction", p.eventAction || b, !0),
                                    void 0 !== p.eventLabel && q("eventLabel", p.eventLabel, !0),
                                    void 0 !== p.value && q("eventValue", Sa(p.value)),
                                        h("send", "event", p.Ha));
                var r = !1;
                var v = Zk;
        ...
        Xk = {cookie_name: 1, cookie_expires: "duration", levels: 1},
        dl = {
            anonymize_ip: 1,
            fatal: 1,
            non_interaction: 1,
        ...
        Rk = function (a, b, c, d) {
            ...
            for (var t = oj(d), r = 0; r < t.length; ++r) {
                var v = t[r],
                    w = f(v);
                if (cl.hasOwnProperty(v)) Yk(cl[v], v, w, h);
                else if (Ok.hasOwnProperty(v)) Yk(Ok[v], v, w, k);
                else if (Nk.hasOwnProperty(v)) Yk(Nk[v], v, w, l);
            ...
            Ia(
                ...
                c
            ) && Wk(k, "nonInteraction", !0);
            "login" === c || "sign_up" === c || "share" === c
                ? Wk(h, "eventLabel", f(C.og))
                : "search" === c || "view_search_results" === c
                ? Wk(h, "eventLabel", f(C.xg))
                : "select_content" === c && Wk(h, "eventLabel", f(C.eg));
            var x = h[C.ka] || {},
                A = x[C.ab];
            A || (0 != A && x[C.I])
                ? (l.allowLinker = !0)
                : !1 === A && Wk(l, "useAmpClientId", !1);
            f(C.Ea) && (l._useUp = !0);
            ...
            Nd(C.B) || ((k.allowAdFeatures = !1), (l.storeGac = !1)));
        ...
        Uk = function (a, b) {
            ...
            var t = null,
                r = f(C.kg);
            a === C.la || a === C.Ya
                ? (t = {action: a, Eb: e(), jb: d(h)})
                : a === C.Wa
                ? (t = {action: "add", jb: d(h)})
                : a === C.Xa
                    ? (t = {action: "remove", jb: d(h)})
                    : a === C.xa
                        ? (t = {action: "detail", Eb: e(k), jb: d(h)})
                        : a === C.Xb
                            ? (t = {action: "impressions", Dh: d(h)})
                            : "view_promotion" === a
                                ? (t = {action: "promo_view", Nd: d(r)})
                                : "select_content" === a && r && 0 < r.length
                                    ? (t = {action: "promo_click", Nd: d(r)})
                                    : "select_content" === a
                                        ? (t = {action: "click", Eb: {list: f(C.Vc) || k}, jb: d(h)})
                                        : a === C.Ka || "checkout_progress" === a
                                            ? (t = {
                                                action: "checkout",
                                                jb: d(h),
    ...
    var kl = function (a, b, c) {
        ...
        rl = function (a, b) {
            var c = bh(b);
            return (a.H[c.containerId] = a.H[c.containerId] || new pl());
        },
        sl = function (a, b, c) {
            if (b) {
                var d = bh(b);
    ...
    aa.insert = function (a, b, c) {
        ...
        0 < this.m.length
            ? this.m.splice(1, 0, new ql(a, d, c, b, !1))
            : this.m.push(new ql(a, d, c, b, !1));
    };
    aa.flush = function (a) {
    ...
    function Ll(a, b) {
        ...
        b &&
        ((c.eventModel = m(b)),
        b[C.Wc] && (c.eventCallback = b[C.Wc]),
        b[C.$b] && (c.eventTimeout = b[C.$b]));
        return c;
    }

    function Ml() {
        (Il = Il || !L.gtagRegistered),
            (L.gtagRegistered = !0),
        Il &&
    ...
    var Pl = {
            ...
            event: function (a) {
                ...
                if (!(2 > a.length) && g(b)) {
                    ...
                    0 < p.length
                        ? (d.eventModel[C.Ma] = n.join())
                        : delete d.eventModel[C.Ma];
                    Kl || F(43);
                    return d;
                }
            },
            ...
            js: function (a) {
                if (2 == a.length && a[1].getTime)
                    return (
                        (Kl = !0), Ml(), {event: "gtm.js", "gtm.start": a[1].getTime()}
                    );
            },
            policy: function () {
            },
            set: function (a) {
                ...
                2 == a.length && ob(a[1])
                    ...
                    g(a[1]) &&
                    ((b = {}),
                        ob(a[2]) || Ha(a[2]) ? (b[a[1]] = m(a[2])) : (b[a[1]] = a[2]));
                if (b) {
                    if ((We(), Ml())) {
                        m(b);
                        var c = m(b);
    ...
    var Qm = G.clearTimeout,
        ...
        Xm = function (a, b, c) {
            var d;
            b
                ? ((a.eventCallback = b), c && (a.eventTimeout = c), (d = qm(a)))
                : (d = qm(a));
            return d;
        },
        Ym = function (a, b) {
    ...
    var eq = window,
        ...
        gq = function (a) {
            ...
            for (
                var d = qf("AMP_TOKEN", String(fq.cookie), !0), e = 0;
                e < d.length;
                e++
            )
    ...
    (Z.g.v = ["google"]),
        (function () {
            (function (a) {
                ...
                var c = Wm(b.replace(/\\\./g, "."), a.vtp_dataLayerVersion || 1),
    ...
    (vq.macro = function (a) {
        ...
        (vq.onHtmlSuccess = ym.lf(!0)),
        (vq.onHtmlFailure = ym.lf(!1));
    vq.dataLayer = cf;
